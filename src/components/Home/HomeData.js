...
const HomeData = () => {
    return (
        <div className='home-data'>
            <h1 className='home-title'>Raju Miah
            ...
            <p className='home-dec'>
                I'm professional developer based in BD, and I'm very passionate and dedicated to my work.
            </p>

            <a href="#contact" className='button button--flex'>Let's Talk
