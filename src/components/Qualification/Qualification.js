...
const Qualification = () => {
  ...
  return (
    <section className="qualification section">
      <SectionHeading title="Qualification" description="My personal journey" />
      ...
      <div className="qualification-container container">
        ...
        <div className="qualification-section">
          ...
          >
            ...
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">MERN Developer</h3>
                <span className="qualification-subtitle">
                  Feni Polytechnic Institute-FPI
                </span>
                <div className="qualification-calender">
          ...
          >
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">Node Developer</h3>
                <span className="qualification-subtitle">
                  Programming - Hero
                </span>
                <div className="qualification-calender">
            ...
            <div className="qualification-data">
              ...
              <div>
                <h3 className="qualification-title">Mongo Developer</h3>
                <span className="qualification-subtitle">
                  Programming - Hero
                </span>
                <div className="qualification-calender">
            ...
            <div className="qualification-data">
              <div>
                <h3 className="qualification-title">Firebase Developer</h3>
                <span className="qualification-subtitle">
                  Programming - Hero
                </span>
                <div className="qualification-calender">
