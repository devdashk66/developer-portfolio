            ...
            <div className="services-container container grid">
                ...
                <div className="services-content">
                    ...
                    <span className='services-button'
                        onClick={() => handelModal(1)}
                    >View More <i class="uil uil-arrow-right services-button-icon"></i></span>

                    <div className={openModal === 1 ? "services-modal active-modal" : "services-modal"}>
                        <div className='services-modal-content'>
                            <i class="uil uil-times services-modal-close"
                                onClick={() => handelModal(0)}
                            ></i>

                            <h3 className='services-modal-title'>Product Designer</h3>

                            <p className='services-modal-dec'>Service with more than 3 years of experience.Providing quality work to clients and companies.</p>
                ...
                <div className="services-content">
                    ...
                    <span className='services-button'
                        onClick={() => handelModal(2)}
                    >View More <i class="uil uil-arrow-right services-button-icon"></i></span>

                    <div className={openModal === 2 ? "services-modal active-modal" : "services-modal"}>
                        <div className='services-modal-content'>
                            <i class="uil uil-times services-modal-close"
                                onClick={() => handelModal(0)}
                            ></i>
                ...
                <div className="services-content">
                    ...
                    <span className='services-button'
                        onClick={() => handelModal(3)}
                    >View More <i class="uil uil-arrow-right services-button-icon"></i></span>

                    <div className={openModal === 3 ? "services-modal active-modal" : "services-modal"}>
                        <div className='services-modal-content'>
                            <i class="uil uil-times services-modal-close"
                                onClick={() => handelModal(0)}
                            ></i>
