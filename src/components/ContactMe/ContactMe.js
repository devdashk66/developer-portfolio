...
const ContactMe = () => {
  ...
  return (
    <section id="contact" className="contact section">
      <SectionHeading title="Get in touch" description="Contact Me" />
        ...
        <div className="contact-content">
          ...
          <div className="contact-info">
            <div className="contact-card">
              ...
              <a href="examplemail@gmail.com.com" className="contact-button">
                Write Me{" "}
            ...
            <div className="contact-card">
              ...
              <a href="https://m.me/crypticalcoderr" className="contact-button">
                Write Me{" "}
                <i className="bx bx-right-arrow-alt contact-button-icon"></i>
              </a>
            </div>
